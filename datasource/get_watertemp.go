...
func parseResponseBody(r []byte) ([]WaterTemperature, error) {
	var data []WaterTemperature
...
func GetDataFromDataSourceFullJson(apiUrl string) ([]WaterTemperature, error) {
...
func GetMockedData() ([]WaterTemperature, error) {
...
func GetLocationWithLowestTemperature(locations []WaterTemperature) WaterTemperature {
...
func WaterTemperatureToString(wts WaterTemperature) string {
	return fmt.Sprintf("%+v\n", wts)
}

func hasLowerTemperature(location1 WaterTemperature, location2 WaterTemperature) bool {
	return location1.Temp_water < location2.Temp_water
}

func GetTemperatureLocationJson(input WaterTemperature) ([]byte, error) {

	temperatureLocation := TemperatureLocation{
		Temperature: input.Temp_water,
		Location:    input.Alias,
	}

	temperatureLocationJson, err := json.Marshal(temperatureLocation)
	if err != nil {
		return nil, err
